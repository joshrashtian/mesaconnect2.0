...
import { IoCopyOutline, IoExpandOutline, IoTrashBinOutline } from 'react-icons/io5'
      ...
      onContextMenu={(e) =>
        createContext(e, [
          ...
          },
          {
            ...
            visible: true,
            function: () => {
              navigator.clipboard.writeText(`localhost:3000/connect/social?event=${event.id}`)
          ...
          {
            name: 'Delete Event',
            visible: userData?.id === event.creator || userData?.role === 'admin',
            function: async () => {
