...
const Dock = () => {
  return (
    <div className="w-full bottom-8 h-16 fixed justify-center items-center flex">
      <section className="group bg-white shadow-md rounded-full h-full w-16 hover:w-96 flex flex-row justify-center items-center duration-500 hover:scale-110 ease-in-out  ">
