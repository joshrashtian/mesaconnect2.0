...
const EditWidgets = ({ current }: { current: any }) => {
  ...
  return (
    <motion.main
      ...
      className="absolute bottom-0 w-full h-1/3 rounded-t-3xl flex flex-col gap-2 p-10 px-10 overflow-x-scroll no-scrollbar shadow-inner opacity-80 bg-zinc-100"
    >
