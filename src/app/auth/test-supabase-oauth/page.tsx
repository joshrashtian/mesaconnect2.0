  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-tr from-purple-400 to-teal-500">
      <div className="flex w-full flex-col gap-4 rounded-3xl bg-white p-10 shadow-md dark:bg-zinc-600 lg:w-2/3">
        <h1 className="text-2xl font-bold">Supabase Default OAuth Test</h1>
        ...
        <div className="space-y-4">
          ...
          >
            {loading ? "Testing..." : "Test Google OAuth (Default)"}
          </button>
          ...
          >
            {loading ? "Testing..." : "Test Apple OAuth (Default)"}
          </button>
        </div>
        ...
        <div className="text-sm text-gray-600">
          <p>This page tests OAuth with Supabase&apos;s default handling.</p>
          <p>
            If this fails, the issue is in your Supabase OAuth configuration.
          </p>
        </div>
      </div>
    </div>
