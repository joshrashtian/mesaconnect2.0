...
const ResponsesPollInfo = ({
  ...
  return (
    <section className="p-5 px-5 h-40 rounded-2xl bg-zinc-50 justify-between flex flex-col">
      ...
      <section className="overflow-x-scroll no-scrollbar">
        {filtered?.map((response: Response, i: number) => (
          <ul
            key={i}
            className="p-2 h-20 w-36 justify-center flex flex-col items-center text-center overflow-hidden bg-white rounded-xl"
          >
