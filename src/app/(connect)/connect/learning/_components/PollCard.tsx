...
const PollCard = ({ data, index }: { data: PollType; index: number }) => {
  ...
  return (
    <motion.div
      ...
      className="p-6 w-64 lg:w-72 h-24 hover:scale-110 hover:shadow-lg border-2 border-amber-600 border-opacity-0 hover:border-opacity-100 duration-300 scale-100 cursor-pointer flex shadow-md flex-col justify-center bg-white dark:bg-slate-700/50 text-white rounded-xl"
    >
