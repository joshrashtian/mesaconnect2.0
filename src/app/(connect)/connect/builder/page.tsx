...
const Page = () => {
  const [selected, setSelected] = useState(BuilderIndex[0]);
  ...
  useEffect(() => {
    const useParams = () => {
      ...
      if(!found) { setSelected(BuilderIndex[0]); return };
  ...
  return (
    <div className="w-full h-full pb-16 flex gap-4 flex-col">
      <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-tr from-orange-700 to-teal-200 ">MESA Studio</h1>
