  ...
  return (
    <main className="w-full font-eudoxus text-center xl:text-left duration-300 flex flex-col xl:gap-0 gap-5">
      <motion.h1
        ...
        className=" text-transparent bg-clip-text bg-gradient-to-br dark:from-slate-400 dark:to-white from-slate-500 to-slate-800 text-3xl"
      >
        {greeting}, {user?.user_metadata.full_name ? user.user_metadata.full_name : userData?.real_name}
      </motion.h1>
      <motion.h1
        className="text-2xl text-slate-600 dark:text-slate-200 font-semibold duration-500"
        initial={{ y: 20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
      ...
      >
        ...
        and the date is{' '}
        <code className="bg-clip-text text-transparent bg-gradient-to-br from-slate-600 to-teal-800 dark:from-teal-400 dark:to-orange-500">
