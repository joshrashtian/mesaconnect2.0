      ...
      >
        ...
        <section className="flex flex-row justify-between ">
          <ul className="w-3/5 flex flex-col gap-5  md:text-lg lg:text-2xl 2xl:text-3xl">
            <h1 className="  ">
              As a community, MESA is here to push and motivate our best selves.
              Leveraging modern technologies, we can help you exprience your
              major and see your ideas come to life.
            </h1>
            <h1 className="text-transparent bg-clip-text bg-gradient-to-br from-slate-400 to-slate-500">
              ...
              inspire. Connect takes it to the next level by bringing MESA a new
              dimesion of community.
            </h1>
          </ul>
          <ul className='w-2/5 bg-teal-200'>

          </ul>
          </section>
        </section>
        <section className="w-full gap-12 flex flex-col bg-zinc-50 shadow- p-10 rounded-3xl">
          <h2 className="text-4xl text-slate-500 font-semibold">with many amazing reasons to join. </h2>
          <Benefits />        
        </section>
      </motion.section>
