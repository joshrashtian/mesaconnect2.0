...
const SignUp = () => {
    ...
    return (
        <main className="h-screen flex justify-center items-center">
          ...
          >
            <h1 className="text-transparent bg-clip-text bg-gradient-to-tr from-pink-700 to-blue-800 font-bold text-5xl p-6 mb-12 border-b-2 border-opacity-65 border-slate-200">
