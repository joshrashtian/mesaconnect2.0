      ...
      <header className="w-full flex flex-col justify-between">
        {image && (
          <ul className="relative w-full h-[600px] rounded-[42px] mb-7 bg-black">
            <Image
              className="rounded-[42px] hover:shadow-2xl shadow-lg hover:scale-[1.02] duration-500"
        ...
        <p className="font-eudoxus font-bold text-slate-400 text-xl">
          {article?.category.toUpperCase()}
        </p>
        <ul className="flex justify-between items-center">
          <h1 className="font-eudoxus font-black bg-gradient-to-tr dark:from-orange-400 dark:to-pink-500 from-red-800 to-orange-600 inline-block bg-clip-text text-transparent text-5xl">
            {article.title}
          </h1>
          <ExpandArticle
        ...
        <ul className="flex flex-row font-eudoxus text-slate-600 dark:text-slate-100 text-lg font-light gap-2 p-0.5 items-center">
