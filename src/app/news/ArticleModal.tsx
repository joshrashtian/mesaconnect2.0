...
export const ArticleModalProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <ul className="absolute flex justify-center overflow-y-scroll min-h-screen w-screen top-0 px-32 pt-32 left-0">
      <main
        onClick={() => {}}
        key={article.id}
        className="bg-white z-50 p-10 rounded-t-2xl overflow-y-scroll shadow-md min-h-full w-3/4 flex flex-col gap-10"
      >
